      ...
      <section id="leadership" className="border-t border-zinc-800 bg-black px-6 py-16 text-white">
        <div className="mx-auto max-w-6xl">
          <div className="mb-10 text-center">
            ...
            <h2 className="mt-2 text-3xl font-bold md:text-4xl">Owners, Founders & CEOs of Sabka Delivery</h2>
            <p className="mx-auto mt-3 max-w-2xl text-gray-400">Karan Nath and Prem Kumar Nath are the owners, founders and CEOs of Sabka Delivery.</p>
          </div>
          <div className="grid gap-8 md:grid-cols-3">
            <article className="overflow-hidden rounded-3xl border border-yellow-500/30 bg-zinc-950 shadow-2xl">
              <div className="flex flex-col items-center p-8 text-center">
                <img src="/founder/karan.jpg" alt="Karan Nath - Owner, Founder and CEO of Sabka Delivery" className="h-40 w-40 rounded-full border-4 border-yellow-500 object-cover shadow-xl" loading="lazy" />
                <p className="mt-6 text-sm font-bold uppercase tracking-widest text-yellow-400">Owner • Founder • CEO</p>
                <h3 className="mt-2 text-3xl font-bold">Karan Nath</h3>
                <div className="mt-5 space-y-2 text-sm leading-6 text-gray-300">
                  <p><strong className="text-white">Roles:</strong> Owner, Founder and CEO</p>
            ...
            <article className="overflow-hidden rounded-3xl border border-yellow-500/30 bg-zinc-950 shadow-2xl">
              <div className="flex flex-col items-center p-8 text-center">
                <img src="/founder/prem.png" alt="Prem Kumar Nath - Owner, Founder and CEO of Sabka Delivery" className="h-40 w-40 rounded-full border-4 border-yellow-500 object-cover shadow-xl" loading="lazy" />
                <p className="mt-6 text-sm font-bold uppercase tracking-widest text-yellow-400">Owner • Founder • CEO</p>
