const structuredData = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      url: "https://sabkadelivery.in/",
      logo: { "@type": "ImageObject", url: "https://sabkadelivery.in/images/sabka-delivery-logo.png" },
      description: "Sabka Delivery is owned, founded and led by Karan Nath and Prem Kumar Nath.",
      owner: [
    ...
    },
    {
      ...
      itemListElement: [
        { "@type": "ListItem", position: 1, name: "Owners, Founders & CEOs — Karan Nath and Prem Kumar Nath", url: "https://sabkadelivery.in/founder" },
...
export default function SeoStructuredData() {
  return <script id="sabka-delivery-website-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(structuredData) }} />;
}
