...
echo "Applying private coupon validation UI..."
node "${script_dir}/patch-private-coupons.mjs"
echo "Adding Commission Slabs sections to Owner and Super Admin panels..."
node "${script_dir}/patch-commission-slab-panels.mjs"
