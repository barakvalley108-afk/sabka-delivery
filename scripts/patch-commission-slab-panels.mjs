...
patch("app/super-admin/admin-console.tsx", [
  [
    '"Coupons"|"Website Editor"|"Panel Users"',
    '"Coupons"|"Commission Slabs"|"Website Editor"|"Panel Users"',
  ],
  [
    'item==="Coupons"?"%":item==="Website Editor"?"✎":',
    'item==="Coupons"?"%":item==="Commission Slabs"?"₹":item==="Website Editor"?"✎":',
  ],
  [
...
patch("app/owner-panel/owner-console.tsx", [
  [
    '"HQ" | "SECURITY" | "OPERATIONS"',
    '"HQ" | "SECURITY" | "OPERATIONS" | "COMMISSION_SLABS"',
  ],
  [
  ...
  [
    '{tab === "SECURITY" && (',
    '{tab === "COMMISSION_SLABS" && <iframe title="Commission Slab Editor" src="/owner-panel/commission-slabs" style={{width:"100%",minHeight:"760px",border:0,borderRadius:16,background:"#fff"}} />}\n\n        {tab === "SECURITY" && (',
  ],
]);
