...
patch("app/super-admin/admin-console.tsx", (source) => {
  ...
  const summaryReplacement = `summary:{totalOrders:number;totalSales:number;deliveryCharges:number;monthlySales:number;monthlyDeliveryCharges:number;activeOrders:number;openStores:number;onlineRiders:number;activePanels:number}`;
...
console.log("Daily and monthly sales/delivery charge metrics added with correct reset labels.");
